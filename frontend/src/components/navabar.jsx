  ...
  return (
    <nav className="bg-white text-gray-900 shadow-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <Link
          to="/"
          className="text-xl sm:text-2xl font-bold tracking-wide text-blue-700 hover:text-black transition duration-300"
        >
        ...
        <button
          ...
          className="md:hidden text-2xl text-gray-800 focus:outline-none transition-transform"
        >
          {menuOpen ? '✖' : '☰'}
        </button>
